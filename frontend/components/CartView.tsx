...
import { Language, t as translate } from '../utils/i18n';
    ...
    if (cart.length === 0) {
        return (
            <div className="text-center bg-white dark:bg-gray-800 p-10 rounded-lg shadow-md">
                <h2 className="text-2xl font-semibold mb-4 dark:text-gray-100">{t('cartIsEmpty', lang)}</h2>
                <button
    ...
    return (
        <div>
            <div className="flex items-center mb-6">
                ...
                <h2 className="text-3xl font-semibold text-gray-800 dark:text-gray-100">{t('shoppingCartTitle', lang)}</h2>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1">
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md sticky top-8">
                        <h3 className="text-xl font-semibold mb-4 border-b dark:border-gray-700 pb-2 text-gray-800 dark:text-gray-100">{t('cartSummary', lang)}</h3>
