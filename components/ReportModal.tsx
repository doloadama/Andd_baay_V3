        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center p-4">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col">
                ...
                <div className="flex-grow overflow-y-auto pr-2">
                    <h3 className="font-semibold text-gray-700 dark:text-gray-200 mb-2">{t('reportPreview', lang)}</h3>
                    {children}
                </div>
                <div className="flex justify-end space-x-4 pt-4 mt-4 border-t dark:border-gray-700">
                    <button onClick={onClose} className="px-4 py-2 bg-gray-200 text-gray-800 dark:bg-gray-600 dark:text-gray-200 rounded-md hover:bg-gray-300 dark:hover:bg-gray-500">{t('close', lang)}</button>
