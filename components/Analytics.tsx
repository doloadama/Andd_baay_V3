        ...
        <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 mb-8">
                <div className="lg:col-span-2 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                    <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-4">{t('projectStatusDistribution', lang)}</h3>
                 ...
                 <div className="lg:col-span-3 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                    <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-4">{t('revenueByCrop', lang)}</h3>
                    <ResponsiveContainer width="100%" height={300}>
                        <BarChart data={analyticsData.revenueByCropData}>
                            ...
                            <Legend wrapperStyle={{ color: isDarkMode ? '#FFFFFF' : '#000000' }}/>
                            <Bar dataKey="revenue" fill="#48BB78" name={t('totalRevenue', lang)}/>
                        </BarChart>
                    </ResponsiveContainer>
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mb-8">
                <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-4">{t('yieldByCrop', lang)}</h3>
                <ResponsiveContainer width="100%" height={300}>
                    <BarChart data={analyticsData.yieldByCropData}>
                        ...
                        <Legend wrapperStyle={{ color: isDarkMode ? '#FFFFFF' : '#000000' }}/>
                        <Bar dataKey="yield" fill="#4299E1" name={t('expectedYield', lang)} />
                    </BarChart>
                </ResponsiveContainer>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                ...
                <div className="flex space-x-2">
                    ...
                    >
                        {loadingInsights ? t('aiInsightsAnalyzing', lang) : t('aiInsightsButton', lang)}
                    </button>
                </div>
                {insights && (
