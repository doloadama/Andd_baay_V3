...
const ChatBot: React.FC<ChatBotProps> = ({ t, lang }) => {
    ...
    useEffect(() => {
        setMessages([{ author: 'bot', text: t('chatBotWelcome', lang) }]);
    }, [lang, t]);
    ...
    const handleSend = async () => {
        ...
        // Fix: Use 'as const' to ensure TypeScript infers a literal type for 'author', resolving the assignment error.
        ...
        try {
            ...
            // Fix: Use a functional update to ensure we are appending to the most recent state, preventing the user's message from disappearing.
