    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center p-4">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-2xl w-full max-w-md">
                <h2 className="text-2xl font-bold mb-6 text-gray-800 dark:text-gray-100">{t('editProfileModalTitle')}</h2>
                <form onSubmit={handleSubmit}>
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="role" value={t(formData.role.toLowerCase())} disabled className="mt-1 block w-full px-3 py-2 bg-gray-200 dark:bg-gray-600 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm" />
                        </div>
                    </div>
